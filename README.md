...
There is a Community-maintained Helm Chart that can be used to run the mailcow-exporter in Kubernetes.
You can find more information on ArtifactHUB: https://artifacthub.io/packages/helm/christianhuth/mailcow-exporter
